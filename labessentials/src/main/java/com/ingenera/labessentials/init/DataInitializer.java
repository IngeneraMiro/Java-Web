package com.ingenera.labessentials.init;


import com.ingenera.labessentials.models.entities.*;
...
public class DataInitializer implements CommandLineRunner {
    private static final VehicleType CAR = VehicleType.CAR;
    private static final VehicleType BUS = VehicleType.BUS;
    private static final VehicleType TRUCK = VehicleType.TRUCK;
    private static final VehicleType MOTORCYCLE = VehicleType.MOTORCYCLE;
    ...
    private static final List<User> SAMPLE_USERS = List.of(
            new User("Default", "Admin", "admin", "admin", Set.of(Role.ADMIN)),
            new User("Ivan", "Pertov", "ivan", "ivan", Set.of(Role.SELLER)),
...
//            log.info("Created Users: {}", userService.getUsers());
        ...
        if(brandService.getBrandsCount() == 0) {
            Brand newBrand = Brand.create("Opel",SAMPLE_BRANDS.get("Opel"));
            brandService.createBrand(newBrand);
            newBrand = Brand.create("BMW",SAMPLE_BRANDS.get("BMW"));
            brandService.createBrand(newBrand);
